...
namespace WireChat.Infrastructure.Exceptions
{
    internal sealed class ExceptionToResponseMapper : IExceptionToResponseMapper
    {
        ...
        public ExceptionResponse Map(Exception exception)
           => exception switch
           {
               ...
               WireChat.Application.Exceptions.ApplicationException ex => new ExceptionResponse(
        ...
        private static string GetExceptionCode(Exception ex)
        {
            ...
            var exceptionCode = ex switch
            {
                ...
                WireChat.Application.Exceptions.ApplicationException applicationException
